 const textConfig = {
  ...
  text3: "Tối mai or tối thứ 6 em có rảnh khum em ._.",
  text4: "Nếu em ko trả lời mà thoát ra tức là muốn làm destiny anh rùi đó nha :v",
  text5: "Em bận rồi???",
  text6: "HI Em rảnh <3",
  text7: "Mai đi uống nước với anh nhá :vvvv",
  text8: "Gửi cho anh <3",
  text9: "oki anh",
  text10: "HÍ HÍ HÍ ",
  text11:
...
$(document).ready(function () {
  ...
  $("#yes").click(function () {
    ...
    Swal.fire({
      ...
      width: 900,
      padding: "3em",
      html: "<input type='text' class='form-control' id='txtReason'  placeholder='HI HI'>",
      background: '#fff url("img/iput-bg.jpg")',
      backdrop: `
                    rgba(0,0,123,0.4)
                    url("img/giphy2.gif")
      ...
      if (result.value) {
        Swal.fire({
          ...
          onClose: () => {
            window.location = "https://m.me/sonnguyen762";
          },
        });
      }
    });
